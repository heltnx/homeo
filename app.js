...
// Assurez-vous que cette ligne existe et que le chemin est correct
class TubeManager {
    constructor() {
        ...
        // Bind the method to ensure it has access to the correct context
        this.renderTubes = this.renderTubes.bind(this);
    }
    ...
    setupListEventListeners(listElement, list) {
        ...
        titleElement.addEventListener('click', toggleList);
